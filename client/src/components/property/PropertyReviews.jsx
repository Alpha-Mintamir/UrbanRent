...
const PropertyReviews = ({ propertyId }) => {
    ...
    const fetchReviews = async () => {
      try {
        ...
        const [reviewsRes, ratingRes] = await Promise.all([
          fetch(`${import.meta.env.VITE_BASE_URL}/reviews/properties/${propertyId}/reviews`, {
            method: 'GET',
            headers: {
          ...
          fetch(`${import.meta.env.VITE_BASE_URL}/reviews/properties/${propertyId}/average-rating`, {
            method: 'GET',
            headers: {
              'Authorization': `Bearer ${localStorage.getItem('token')}`
            },
  ...
  const handleSubmitReview = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BASE_URL}/reviews/properties/${propertyId}/reviews`, {
        method: 'POST',
        headers: {
